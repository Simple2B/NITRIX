...
def upgrade():
    ...
    sa.Column('change_type', sa.Enum('creation_account', 'deletion_account', 'changes_account', 'extension_account_new', 'extensions_account_change', 'extensions_account_delete', 'creation_reseller', 'deletion_reseller', 'changes_reseller', 'creation_product', 'deletion_product', 'changes_product', 'creation_reseller_product', 'deletion_reseller_product', 'changes_reseller_product', 'creation_phone', 'changes_phone', 'deletion_phone', name='edittype'), nullable=True),
