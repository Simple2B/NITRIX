...
Revision ID: 027e6433c105
Revises: 
Create Date: 2021-11-08 14:59:46.687508
...
def upgrade():
    ...
    sa.Column('status', sa.Enum('active', 'not_active', name='status'), nullable=True),
    sa.Column('price', sa.Float(), nullable=True),
    sa.Column('deleted', sa.Boolean(), nullable=True),
    sa.Column('ninja_product_id', sa.Integer(), nullable=True),
    ...
    sa.Column('name', sa.String(length=60), nullable=False),
    sa.Column('status', sa.Enum('active', 'not_active', name='status'), nullable=True),
    sa.Column('comments', sa.String(length=60), nullable=True),
    sa.Column('deleted', sa.Boolean(), nullable=True),
    sa.Column('last_activity', sa.DateTime(), nullable=True),
    sa.Column('ninja_client_id', sa.Integer(), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name')
    )
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=60), nullable=False),
    sa.Column('user_type', sa.Enum('super_admin', 'admin', 'user', name='type'), nullable=True),
    sa.Column('password_hash', sa.String(length=255), nullable=True),
    sa.Column('activated', sa.Enum('active', 'not_active', name='status'), nullable=True),
    sa.Column('deleted', sa.Boolean(), nullable=True),
    ...
    op.create_table('reseller_product',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('product_id', sa.Integer(), nullable=True),
    sa.Column('reseller_id', sa.Integer(), nullable=True),
    sa.Column('months', sa.Integer(), nullable=True),
    ...
    sa.Column('change_type', sa.Enum('sim', 'name', 'imei', 'product', 'phone', 'reseller', 'months', 'activation_date', 'created', 'deleted', name='changetype'), nullable=True),
    sa.Column('value_str', sa.String(length=60), nullable=False),
    sa.Column('new_value_str', sa.String(length=60), nullable=True),
    sa.ForeignKeyConstraint(['account_id'], ['accounts.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('account_extension',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('account_id', sa.Integer(), nullable=True),
